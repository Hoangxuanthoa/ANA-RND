...
export default function LoginPage() {
  ...
  return (
    <main className="flex h-screen w-full overflow-hidden bg-surface">
      {/* Brand panel */}
      <div className="relative hidden w-[520px] flex-shrink-0 flex-col justify-between overflow-hidden bg-accent p-12 md:flex">
        <svg
          width="560"
          height="560"
          viewBox="0 0 200 200"
          fill="none"
          className="absolute -top-36 -right-48 opacity-15"
        >
          <circle cx="100" cy="100" r="95" stroke="white" strokeWidth="1.2" />
          <circle cx="100" cy="100" r="72" stroke="white" strokeWidth="1.2" />
          <circle cx="100" cy="100" r="49" stroke="white" strokeWidth="1.2" />
          <circle cx="100" cy="100" r="26" stroke="white" strokeWidth="1.2" />
        </svg>
        ...
        <div className="relative">
          <h1 className="mb-4 max-w-[400px] text-[34px] font-extrabold leading-tight text-white">
            Thư viện thiết kế, quản lý dự án &amp; phản hồi khách hàng — một chỗ.
          </h1>
          <p className="max-w-[380px] text-[15px] leading-relaxed text-white/85">
            Library → Reuse → Project → Develop → Feedback → Approve → Release → Library.
          </p>
        </div>

        <p className="relative text-[13px] text-white/60">
          © 2026 — Internal tool, không chia sẻ ra ngoài công ty.
        </p>
      </div>
